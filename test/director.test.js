...
describe('api/director tests',()=>{
  ...
  describe('/POST directors', ()=>{
    it('it should post a directos',(done)=>{
      const director = {
        name: 'DirectorNameTest',
        surname:'DirectorSurnameTest',
        bio : 'Director Bio Test'
      };
      chai.request(server)
        .post('/api/directors')
        .send(director)
  ...
  describe('/PUT/:director_id director', ()=>{
    it('it should update a director given by id',(done)=>{
      const director = {
        name: 'DirectorNameTestEdited',
        surname:'DirectorSurnameTestEdited',
        bio : 'Director Bio TestEdited'
      };
      chai.request(server)
